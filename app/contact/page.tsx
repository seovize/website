            ...
            <div>
              ...
              <div className="mt-8 grid grid-cols-2 gap-3 sm:grid-cols-4 lg:grid-cols-2 xl:grid-cols-4">
                {[
                  ...
                  { v: "93", l: "Verified reviews" },
                  { v: "< 1d", l: "Response time" },
                  { v: "4.3★", l: "Client rating" },
                ].map((s) => (
              ...
              <div className="mt-10 rounded-2xl border border-line bg-navy p-6">
                <div className="flex gap-0.5 mb-3">
                  {[1,2,3,4,5].map((i) => (
                    <svg key={i} className="h-3 w-3 text-orange" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    <div className="grid gap-4 sm:grid-cols-2">
                      <label className="grid gap-1.5">
                        ...
                        >
                          ...
                          <option>Semantic SEO</option>
                          <option>Local SEO — Texas</option>
